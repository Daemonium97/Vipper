            ...
            <Row style={{
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <p style={{
                        color: 'white',
                        fontSize: '24px'
                    }}>customer service make us one of the most prestigious per head in the industry. Our vision is to</p>
                    <p style={{
                        color: 'white',
                        fontSize: '24px'
                    }}>be able to offer our clients a premium service at a very affordable cost. </p>
                </div>
                <div style={{
                    textAlign: 'center',
                    paddingBottom: '90px'
                    ...
                    <p style={{
                        color: 'white',
                        fontSize: '24px'
                    }}>In order to achive this vision real, we develop an infrastructure with the bests software and</p>
                    <p style={{
                        color: 'white',
                        fontSize: '24px'
                    }}>hardware, as well as the best and most trained customer service staff. </p>
                </div>
                <div style={{ textAlign: 'center' }}>
